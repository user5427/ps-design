...
\subsubsubsection{Spa appointment booking confirmation}
Ann, a student in her twenties, calls a spa to book a quick appointment. The receptionist promises to send a confirmation by SMS, but since it’s done manually, the message arrives late. Ann, unsure if her appointment is valid, cancels and goes elsewhere instead.

\subsubsubsection{Customized orders}

Lucas, a 26-year-old customer, places an order for a smoothie with multiple variations at a café. The barista manually writes down the order without any system validation for the variations. Later, the staff member preparing the drinks notices conflicts in the requested options and asks Lucas to choose different variations. This error reduces his trust in the staff’s ability to process customized orders accurately and reliably.
...
Sarah, 27, spots a “Buy One, Get One Free” coffee offer on a café’s
...
causes a delay at the counter and creates an awkward queue behind  her.
