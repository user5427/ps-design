...
\begin{itemize}
    ...
    % memorization - not really important kadangi darbuotojai sistema naudosis visą dieną taigi bet kokiu atveju atsimins
    % primary as customers use system directly
...
\begin{itemize}
    ...
    % this is secondary stakeholder (statistics), indirect (ownder)
\end{itemize}
...
% 4 level section should be working now
% \subsubsubsection{test test}
