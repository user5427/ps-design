...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/diagrams/services/order_client_seating_available.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/diagrams/services/order_place_order_sequence.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/diagrams/services/order_modify_order_sequence.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/diagrams/services/order_cancel_order_sequence.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{diagrams/business/bpmn_user_manage.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{diagrams/business/bpmn_products_services.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{diagrams/business/bpmn_product_variations.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{diagrams/business/bpmn_employee_manage.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{diagrams/business/bpmn_business_info_manage.png}
