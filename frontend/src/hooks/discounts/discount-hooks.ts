...
export const discountKeys = {
    ...
    applicable: {
        order: (menuItemIds: string[], orderTotal: number) =>
            [...discountKeys.all, "applicable", "order", menuItemIds, orderTotal] as const,
        service: (serviceDefinitionId: string, servicePrice: number) =>
            [...discountKeys.all, "applicable", "service", serviceDefinitionId, servicePrice] as const,
    },
};
...
export function useApplicableServiceDiscount(
    ...
    return useQuery({
        queryKey: discountKeys.applicable.service(serviceDefinitionId, servicePrice),
        queryFn: () => getApplicableServiceDiscount(serviceDefinitionId, servicePrice),
