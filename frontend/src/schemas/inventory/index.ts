...
export type ProductUnit = import("@ps-design/schemas/inventory/units").ProductUnitResponse;
export type CreateProductUnit = import("@ps-design/schemas/inventory/units").CreateProductUnitBody;
export type UpdateProductUnit = import("@ps-design/schemas/inventory/units").UpdateProductUnitBody;

export type Product = import("@ps-design/schemas/inventory/products").ProductResponse;
export type CreateProduct = import("@ps-design/schemas/inventory/products").CreateProductBody;
export type UpdateProduct = import("@ps-design/schemas/inventory/products").UpdateProductBody;
