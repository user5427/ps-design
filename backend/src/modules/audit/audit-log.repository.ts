...
export class AuditLogRepository {
    constructor(private businessLogRepo: Repository<AuditBusinessLog>, private securityLogRepo: Repository<AuditSecurityLog>) { }
    ...
    async findByEntity(entityType: string, entityId: string): Promise<AuditBusinessLog[]> {
        return this.businessLogRepo.find({
    ...
    async create(data: ICreateAuditBusinessLog | ICreateAuditSecurityLog): Promise<AuditBusinessLog | AuditSecurityLog> {
    ...
    async getEntitySnapshot(entityType: string, entityId: string): Promise<Record<string, any> | null> {
